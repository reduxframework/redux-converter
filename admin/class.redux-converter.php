<?php
    ...
    class Redux_Converter {
        ...
        private function __construct() {
            ...
            add_filter( 'vp_option_configuration_array', array( $this, 'grab_vp_options' ) );
        ...
        function tgm_init() {
            ...
            $config = array(
                ...
                'menu'             => 'install-redux-framework',
                // Menu slug
                'has_notices'      => true,
                // Show admin notices or not
                'is_automatic'     => true,
                // Automatically activate plugins after installation or not
                'message'          => __( 'Redux Converter requires Redux Framework to function. Click install below to begin the process.', $theme_text_domain ),
                ...
                'strings'          => array(
                    ...
                    'notice_can_install_required'     => _n_noop( '%1$s is required to use Redux Converter.', '%1$s  is required to use Redux Converter.' ),
                    // %1$s = plugin name(s)
        ...
        function check_for_frameworks() {
            ...
            if ( defined( 'VP_VERSION' ) ) {
                $this->frameworks['VafPress'][] = new Convert2Redux( $this, "VafPress" );
            }

        }


        function grab_vp_options( $config ) {

            $this->vafpress_config[$config['option_key']] = $config;
